...
const COPY = {
  es: {
    ...
    billing2: 'Puedes cancelar cuando quieras escribiendo a support@moyiq.app. Tu acceso Pro sigue activo hasta el final del período ya pagado — no se hacen reembolsos parciales por el tiempo no usado, salvo la garantía de 14 días desde tu primera compra (ver la landing para el detalle de esa garantía).',
