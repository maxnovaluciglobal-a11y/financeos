...
export function IconInicio({ size = 24, className }) {
  return (
    <svg {...base} width={size} height={size} className={className} fill="none" stroke="var(--navy)" strokeWidth="1.5" strokeLinecap="round">
...
export function IconTarjetas({ size = 24, className }) {
  return (
    <svg {...base} width={size} height={size} className={className} fill="none" stroke="var(--navy)" strokeWidth="1.5">
...
export function IconPresupuesto({ size = 24, className }) {
  return (
    <svg {...base} width={size} height={size} className={className} fill="none" stroke="var(--navy)" strokeWidth="1.5">
      ...
      <path d="M4 16 h5.3 v0 H4Z" fill="var(--navy)" stroke="none" />
    </svg>
  )
}
...
export function IconInversion({ size = 24, className }) {
  return (
    <svg {...base} width={size} height={size} className={className} fill="none" stroke="var(--navy)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
...
export function IconNotificaciones({ size = 24, className }) {
  return (
    <svg {...base} width={size} height={size} className={className} fill="none" stroke="var(--navy)" strokeWidth="1.5" strokeLinecap="round">
      ...
      <circle cx="11" cy="9" r="1.2" fill="var(--navy)" stroke="none" />
    </svg>
  )
}
...
export function IconEscanear({ size = 24, className }) {
  return (
    <svg {...base} width={size} height={size} className={className} fill="none" stroke="var(--navy)" strokeWidth="1.6" strokeLinecap="round">
